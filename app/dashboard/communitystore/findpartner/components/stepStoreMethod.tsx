...
import { CommunityuseParticStore, useParticStore } from "@/store/store";
import Image from "next/image";
import { useState } from "react";

const StoreMethodtypecom = () => {
  const { share, setMode, updateShare } = CommunityuseParticStore();
  const DAYS = [
    "Monday",
    "Tuesday",
    "Wednesday",
...
export default StoreMethodtypecom;
